...
/**
 * The state of a {@link SinkWriter} implementation. Contains {@code outstandingMessages} that
 * could not be delivered in a checkpoint. Used in the {@link RabbitMQSinkWriterAtLeastOnce}
 * and {@link RabbitMQSinkWriterExactlyOnce} implementations.
 */
