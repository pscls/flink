 ...
 */
final class RabbitMQDeserializationSchemaWrapper<OUT> implements RMQDeserializationSchema<OUT> {
	private final DeserializationSchema<OUT> schema;

	RabbitMQDeserializationSchemaWrapper(DeserializationSchema<OUT> deserializationSchema) {
