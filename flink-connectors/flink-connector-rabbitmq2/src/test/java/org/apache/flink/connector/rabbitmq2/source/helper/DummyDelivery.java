...
public class DummyDelivery {
	...
	public static Delivery build(String mockedCorrelationId, long mockedDeliveryTag, String mockedBody) {
	...
	public static Delivery build() {
		return DummyDelivery.build(DummyDelivery.defaultCorrelationId, DummyDelivery.defaultDeliveryTag, DummyDelivery.defaultMessage);
	}
